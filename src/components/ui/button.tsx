  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white hover:shadow-glow transform hover:-translate-y-0.5 shadow-accent font-semibold",
        gradient: "bg-gradient-primary text-white hover:opacity-90 shadow-medium hover:shadow-glow",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-soft hover:shadow-medium",
        viral: "bg-gradient-hero text-white hover:shadow-glow transform hover:scale-105 shadow-accent font-bold animate-pulse hover:animate-none",
      },
      size: {
